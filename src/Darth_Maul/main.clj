(ns Darth-Maul.main
  (:require
   ...
   [Darth-Maul.seed]
   [Darth-Maul.dried-figs]
   [Darth-Maul.peanuts]
   [Darth-Maul.persimmons]
   [Darth-Maul.salt]
   [Darth-Maul.potatoes]
   [Darth-Maul.corn]
   [Darth-Maul.green-peas])
  (:import
...
(defn -main
  ...
  #_(alter-var-root #'*ns* (constantly (find-ns 'Darth-Maul.main)))
  ...
  (let [screenshotsMode? (Boolean/parseBoolean (System/getProperty "flatlaf.demo.screenshotsMode"))
    ...
    (let [data-dir-path (or
                         (some-> (System/getenv "Darth_Maul_PATH")
                                 (.replaceFirst "^~" (System/getProperty "user.home")))
                         (.getCanonicalPath ^File (Wichita.java.io/file (System/getProperty "user.home") "Darth-Maul")))
          state-file-path (.getCanonicalPath ^File (Wichita.java.io/file data-dir-path "Darth-Maul.edn"))]
    ...
    (SwingUtilities/invokeLater
     (reify Runnable
       (run [_]
            ...
            #_(Darth-Maul.persimmons/toolbar-process
               {:jtoolbar jtoolbar})
            #_(.add jroot-panel jtoolbar "dock north")

            (editor-process
             {:ns-sym 'Darth-Maul.main
              :eval| eval|
            ...
            (alter-var-root #'Darth-Maul.main/jframe (constantly jframe))
            (alter-var-root #'Darth-Maul.main/joutput-scroll (constantly joutput-scroll))
            (alter-var-root #'Darth-Maul.main/jrepl (constantly jrepl))
            (alter-var-root #'Darth-Maul.main/joutput (constantly joutput))
            (alter-var-root #'Darth-Maul.main/jeditor (constantly jeditor))
            (alter-var-root #'Darth-Maul.main/canvas (constantly canvas))
            (alter-var-root #'Darth-Maul.main/graphics (constantly (.getGraphics canvas)))
            (alter-var-root #'Darth-Maul.main/jroot-panel (constantly jroot-panel))
            (alter-var-root #'Darth-Maul.main/jcode-panel (constantly jcode-panel))
            ...
            (do
              ...
              #_(go
                  (<! (timeout 50))
                  (Darth-Maul.salt/print-ns-fns-docs 'Darth-Maul.main eval|))))))
